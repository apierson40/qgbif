...
class QGBIFPlugin:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir, "i18n", "QGBIF_{}.qm".format(locale)
        )
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate("QGBIF", message)
    ...
    def initGui(self):
        ...
        icon_path = interfaces_path('icons', 'icon.png')
        self.add_action(
            icon_path,
            text=self.tr(u"QGBIS"),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(self.tr(u"&QGBIF"), action)
    ...
    def run_tests():
        ...
        try:
            ...
            from qgbif.qgis_tools.test_tools.test_runner import test_package
